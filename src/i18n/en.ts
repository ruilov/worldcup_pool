const en = {
  ...
  matches: {
    ...
    scoreInputTeam1Aria: 'Score for {{team}}',
    scoreInputTeam2Aria: 'Score for {{team}}',
    settleContracts: 'Settle contracts',
    updatingScore: 'Updating…',
    invalidScore: 'Please enter whole numbers or leave blank.',
    failedToUpdateScore: 'Failed to update score',
    kickoffTBD: 'TBD',
    challengeNotFound: 'Challenge not found',
    failedToLoadMatches: 'Failed to load matches',
  },
  auth: {
    heading: 'Sign in with an email link',
    description: 'Enter your email and we will send you a one-time sign-in link.',
    emailLabel: 'Email',
    emailPlaceholder: 'you@example.com',
    sending: 'Sending…',
    sendLink: 'Send sign-in link',
    linkSentHeading: 'Link sent',
    linkSentDescriptionEmail: 'Check your email for the sign-in link we sent to {{email}}.',
    linkSentDescription: 'Check your email for the sign-in link.',
    linkResent: 'Link resent. Check your inbox.',
    resendLink: 'Resend link',
    resending: 'Resending…',
    backToAuth: 'Use a different email',
    verifyHeading: 'Signing you in…',
    verifyDescription: 'Hang tight while we confirm your link.',
